...
ability the operator has at this keyboard. If the operator could do it from
this computer, the agent must use Synapse and host workflows to make it happen,
then inspect the physical source of truth.
